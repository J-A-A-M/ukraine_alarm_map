...
std::map<Type, SettingItemInt> intSettings = {
    ...
    {BUTTON_1_PIN, {"bp", -1}},
    {BUTTON_2_PIN, {"b2p", -1}},
    {ALERT_PIN_BISTABLE, {"apb", -1}},
    {ALERT_PIN_IMPULSE, {"api", -1}},
    {CLEAR_PIN_IMPULSE, {"cpi", -1}},
    {ALERT_PIN_BISTABLE_INVERT, {"apbi", 0}},
    {ALERT_PIN_IMPULSE_INVERT, {"apii", 0}},
    {CLEAR_PIN_IMPULSE_INVERT, {"cpii", 0}},
    {BUZZER_PIN, {"bzp", -1}},
    {DF_RX_PIN, {"dfrx", -1}},
    {DF_TX_PIN, {"dftx", -1}},
