...
from updater.updater import update_alerts_websocket_v2
        ...
        [
            {
                ...
                "activeAlerts": [
                {
                    ...
                    "regionType": "District",
                    "type": "AIR",
                    "lastUpdate": "2025-01-15T09:00:00Z"
                },
                {
                    "regionId": "1",
                    "regionType": "State",
...
async def test_5(mock_get_alerts, mock_get_regions, mock_get_cache_data):
    ...
    expected_result = [[1, 1700000000], [1, 1736935200], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], 
                        [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], 
                        [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], 
                        [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], 
                        [0, 1645674000], [0, 1645674000]
...
async def test_11(mock_get_alerts, mock_get_regions, mock_get_cache_data):
    ...
    expected_result = [[0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], 
                        [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], 
                        [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], 
                        [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], [0, 1645674000], 
                        [0, 1645674000], [0, 1645674000]
