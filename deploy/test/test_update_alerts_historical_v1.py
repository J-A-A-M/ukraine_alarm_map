    ...
    mock_get_alerts.return_value = [
        {
            ...
            "lastUpdate": "2022-04-04T16:45:00Z",
            "activeAlerts": [
                {"regionId": "1", "regionType": "State", "type": "ARTILLERY", "lastUpdate": "2022-04-04T16:45:00Z"}
            ],
        }
    ]
    ...
    mock_get_alerts.return_value = [
        {
            ...
            "activeAlerts": [
                {"regionId": "1", "regionType": "State", "type": "ARTILLERY", "lastUpdate": "2022-04-04T16:45:00Z"},
                {"regionId": "1", "regionType": "State", "type": "AIR", "lastUpdate": "2022-04-04T16:00:00Z"},
            ],
        }
    ]
...
async def test_9(mock_get_alerts, mock_get_historical_alerts, mock_get_websocket, mock_datetime):
    ...
    mock_get_alerts.return_value = [
        {
            ...
            "activeAlerts": [
                {"regionId": "1", "regionType": "State", "type": "ARTILLERY", "lastUpdate": "2022-02-02T22:22:22Z"}
            ],
        }
    ]
    ...
    mock_get_websocket.return_value = {
        "1": {
            ...
            "activeAlerts": [
                {"regionId": "1", "regionType": "State", "type": "AIR", "lastUpdate": "2022-02-02T22:22:22Z"},
                {"regionId": "1", "regionType": "State", "type": "ARTILLERY", "lastUpdate": "2022-01-01T11:11:11Z"},
            ],
        },
        "2": {
            "regionId": "2",
