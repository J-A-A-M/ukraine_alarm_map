    ...
    mock_get_alerts.return_value = [
        {
            ...
            "activeAlerts": [
                {"regionId": "66", "regionType": "District", "type": "AIR", "lastUpdate": "2025-01-15T10:00:00Z"},
                {"regionId": "61", "regionType": "District", "type": "AIR", "lastUpdate": "2025-01-15T11:00:00Z"},
            ],
        }
    ]
    mock_get_regions.return_value = districts
    ...
    mock_get_alerts.return_value = [
        {
            ...
            "activeAlerts": [
                {"regionId": "66", "regionType": "District", "type": "AIR", "lastUpdate": "2025-01-15T10:00:00Z"},
                {"regionId": "61", "regionType": "District", "type": "AIR", "lastUpdate": "2025-01-15T11:00:00Z"},
                {"regionId": "11", "regionType": "State", "type": "AIR", "lastUpdate": "2025-01-16T12:00:00Z"},
            ],
        }
    ]
    mock_get_regions.return_value = districts
    ...
    mock_get_alerts.return_value = [
        {
            ...
            "activeAlerts": [
                ...
                {"regionId": "66", "regionType": "District", "type": "AIR", "lastUpdate": "2025-01-15T15:00:00Z"},
            ],
        }
    ]
    mock_get_regions.return_value = districts
    ...
    mock_get_alerts.return_value = [
        {
            ...
            "activeAlerts": [
                {"regionId": "11", "regionType": "State", "type": "AIR", "lastUpdate": "2025-01-18T11:00:00Z"},
            ],
        }
    ]
    mock_get_regions.return_value = districts
